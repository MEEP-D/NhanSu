...
//		contentPane.add(header,BorderLayout.NORTH);
		pnTop.add(header, BorderLayout.NORTH);
...
//		menubar.setPreferredSize(new Dimension(220,760));
		...
		pnWest.setPreferredSize(new Dimension(220,760));
		panelBottom.add(pnWest,BorderLayout.WEST);  
	    ...
	    pnWest.add(headerPanel);
	    
	    JPanel pnXX = new JPanel();
	    pnXX.setPreferredSize(new Dimension(0, 150));
	    pnWest.add(pnXX);
	    
	 // Tạo các JLabel riêng lẻ với nội dung ngắn gọn
	    JLabel lblCompanyName = new JLabel("Công ty TNHH Minh Mèo");
	    lblCompanyName.setFont(new Font("sansserif", Font.BOLD, 13));
	    lblCompanyName.setForeground(new Color(0, 0, 0, 180));

	    JLabel lblSlogan = new JLabel("Giải pháp nhân sự toàn diện");
	    lblSlogan.setFont(new Font("sansserif", Font.ITALIC, 12));
	    lblSlogan.setForeground(new Color(0, 0, 0, 150));

	    JLabel lblYear = new JLabel("Thành lập: 2012");
	    lblYear.setFont(new Font("sansserif", Font.PLAIN, 12));
	    lblYear.setForeground(new Color(0, 0, 0, 150));

	    JLabel lblMission = new JLabel("Sứ mệnh: Kết nối nhân tài");
	    lblMission.setFont(new Font("sansserif", Font.PLAIN, 12));
	    lblMission.setForeground(new Color(0, 0, 0, 150));

	    // Thêm khoảng cách giữa các dòng
	    lblSlogan.setBorder(BorderFactory.createEmptyBorder(20, 0, 0, 0));
	    lblYear.setBorder(BorderFactory.createEmptyBorder(20, 0, 0, 0));
	    lblMission.setBorder(BorderFactory.createEmptyBorder(2, 0, 0, 0));

	    // Tạo JPanel chứa thông tin công ty
	    ...
	    companyInfoPanel.add(lblCompanyName);
	    companyInfoPanel.add(lblSlogan);
	    companyInfoPanel.add(lblYear);
	    companyInfoPanel.add(lblMission);

	    // Thêm vào pnWest
	    pnWest.add(companyInfoPanel);

		
		menubar = new myMenuBar2(Color.decode("#1CB5E0"), Color.decode("#000046"));
		menubar.setPreferredSize(new Dimension(1100,70));
		pnTop.add(menubar, BorderLayout.SOUTH);
...
//		UngVienMouse
	...
	public void tienXuLy() {
		...
		System.out.println("check nhan vien: " + nhanVien.getHoTen());
		this.menubar.getLbName().setText(nhanVien.getHoTen());
		this.menubar.getLbChucVu().setText(nhanVien.getChucVu().getTenChucVu());
		labelName.setText(nhanVien.getHoTen());
		labelChucVu.setText(nhanVien.getChucVu().getTenChucVu());
